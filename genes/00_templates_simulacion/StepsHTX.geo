...
gap_z = 1.0e-3;      // separaci??n axial entre imanes interiores


// =======================================================
// PAR??METROS AMB (Bobina axial)
// =======================================================
rb1 = 12.7e-3;      // radio interno bobina
rb2 = 18.7e-3;      // radio externo bobina
hb  = 12.7e-3;      // altura bobina

gap_pc = 4.0e-3;     // separaci??n axial PMB ??? bobina
...
// =======================================================
Mesh.Algorithm3D = 10;      // prueba luego también con 10 (HXT)
Mesh.Smoothing   = 8;
Mesh.Optimize    = 1;
