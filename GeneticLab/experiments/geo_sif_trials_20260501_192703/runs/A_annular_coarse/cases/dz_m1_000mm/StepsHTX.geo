...
Field[10].XMin = -0.0145; Field[10].XMax = 0.0145;
Field[10].YMin = -0.0145; Field[10].YMax = 0.0145;
Field[10].ZMin = -0.01405; Field[10].ZMax = -0.00265;
...
Field[12].XMin = -0.026; Field[12].XMax = 0.026;
Field[12].YMin = -0.026; Field[12].YMax = 0.026;
Field[12].ZMin = -0.024; Field[12].ZMax = 0.018;

Field[13] = Box;
Field[13].VIn = lc_mid; Field[13].VOut = lc_far;
Field[13].XMin = -0.034; Field[13].XMax = 0.034;
Field[13].YMin = -0.034; Field[13].YMax = 0.034;
Field[13].ZMin = -0.028; Field[13].ZMax = 0.024;
